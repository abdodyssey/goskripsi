...
// --- My Documents ---
router.get("/my/documents", auth_middleware_1.requireAuth, mahasiswa_controller_1.mahasiswaController.getMyDocuments);
router.post("/my/documents", auth_middleware_1.requireAuth, mahasiswa_controller_1.mahasiswaController.updateDocument);
router.delete("/my/documents/:jenis", auth_middleware_1.requireAuth, mahasiswa_controller_1.mahasiswaController.deleteDocument);
openapi_generator_1.registry.registerPath({
    method: "get",
