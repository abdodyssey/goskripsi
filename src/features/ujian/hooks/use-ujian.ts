...
export const useUjian = () => {
  ...
  const deleteSchedulingMutation = useMutation({
    mutationFn: (id: string) => ujianService.delete(id),
    onSuccess: () => {
  ...
  return {
    ...
    deleteScheduling: deleteSchedulingMutation.mutateAsync,
    isDeleting: deleteSchedulingMutation.isPending,
    useUjianById,
    useFormPenilaian,
    useKeputusanOptions,
