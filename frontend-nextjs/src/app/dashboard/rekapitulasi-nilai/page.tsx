            ...
            <Paper p="md" withBorder radius="md">
              <Stack gap="xs">
                ...
                <Table variant="unstyled" verticalSpacing="xs">
                  ...
                  <Table.Tbody>
                    {Object.values(
                      selectedItem.penilaians.reduce(
                        (
                          acc: Record<
                            number,
                          ...
                          if (!acc[curr.dosenId]) {
                            acc[curr.dosenId] = {
                              nama: curr.dosen.user.nama,
                              total: 0,
                              count: 0,
                            };
                          }
                          acc[curr.dosenId].total += Number(curr.nilai || 0);
                          acc[curr.dosenId].count += 1;
                          return acc;
                        },
                        {},
                      ),
                      ...
                      <Table.Tr key={idx}>
                        ...
                        <Table.Td ta="right" style={{ fontSize: "13px" }}>
                          <Text fw={600}>
                            {(group.total / (group.count || 1)).toFixed(2)}
                          </Text>
                        </Table.Td>
                      </Table.Tr>
                    ))}
