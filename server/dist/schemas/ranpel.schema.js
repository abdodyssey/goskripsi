...
exports.updatePengajuanRanpelSchema = zod_1.z.object({
    body: zod_1.z
        ...
        // Section comments
        komen_pa_masalah: zod_1.z.string().optional().nullable(),
        komen_pa_solusi: zod_1.z.string().optional().nullable(),
        komen_pa_hasil: zod_1.z.string().optional().nullable(),
        komen_pa_data: zod_1.z.string().optional().nullable(),
        komen_pa_metode: zod_1.z.string().optional().nullable(),
        komen_kpr_masalah: zod_1.z.string().optional().nullable(),
        komen_kpr_solusi: zod_1.z.string().optional().nullable(),
        komen_kpr_hasil: zod_1.z.string().optional().nullable(),
        komen_kpr_data: zod_1.z.string().optional().nullable(),
        komen_kpr_metode: zod_1.z.string().optional().nullable(),
    })
