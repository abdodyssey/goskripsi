    ...
    if (roleName === "mahasiswa") {
      await prisma.mahasiswa.upsert({
        ...
        update: {
          ...
          ipk:
            payload.ipk !== undefined && payload.ipk !== null
              ? payload.ipk
              : undefined,
          semester:
            payload.semester !== undefined && payload.semester !== null
              ? payload.semester
              : undefined,
        },
        create: {
    ...
    if (role === "mahasiswa") {
      ...
      if (mahasiswa) {
        return {
          ...
          active_pendaftaran: (
            await prisma.pendaftaranUjian.findMany({
