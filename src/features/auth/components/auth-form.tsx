  ...
  return (
    ...
    >
      <Box mb={32}>
        ...
        <Title order={1} fw={700} fz={24} className="tracking-tight text-slate-900 dark:text-white mb-1">
          Selamat Datang
        </Title>
      ...
      <form onSubmit={form.onSubmit(onSubmit)}>
        <Stack gap="xl">
          <TextInput
            ...
            size="sm"
            radius="md"
            leftSection={<IconUser size={16} stroke={1.5} className="text-indigo-500" />}
            styles={{
              input: { backgroundColor: 'var(--mantine-color-gray-0)', border: 'none' },
              label: { marginBottom: 6, fontSize: 12, fontWeight: 600, color: 'var(--mantine-color-slate-7)' },
            }}
          ...
          <PasswordInput
            ...
            size="sm"
            radius="md"
            leftSection={<IconLock size={16} stroke={1.5} className="text-indigo-500" />}
            styles={{
              input: { backgroundColor: 'var(--mantine-color-gray-0)', border: 'none' },
              label: { marginBottom: 6, fontSize: 12, fontWeight: 600, color: 'var(--mantine-color-slate-7)' },
            }}
